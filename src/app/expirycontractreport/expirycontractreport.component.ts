...
@Component({
  selector: 'app-expirycontractreport',
  templateUrl: './expirycontractreport.component.html',
  styleUrls: ['./expirycontractreport.component.css']
})
export class ExpirycontractreportComponent implements OnInit {
