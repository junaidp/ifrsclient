...
@Component({
  selector: 'app-modificationreportslist',
  templateUrl: './modificationreportslist.component.html',
  styleUrls: ['./modificationreportslist.component.css']
})
export class ModificationreportslistComponent implements OnInit {
