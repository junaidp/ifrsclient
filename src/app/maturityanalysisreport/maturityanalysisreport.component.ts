...
@Component({
  selector: 'app-maturityanalysisreport',
  templateUrl: './maturityanalysisreport.component.html',
  styleUrls: ['./maturityanalysisreport.component.css']
})
export class MaturityanalysisreportComponent implements OnInit {
