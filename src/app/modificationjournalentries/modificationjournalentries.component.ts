...
@Component({
  selector: 'app-modificationjournalentries',
  templateUrl: './modificationjournalentries.component.html',
  styleUrls: ['./modificationjournalentries.component.css']
})
export class ModificationjournalentriesComponent implements OnInit {
