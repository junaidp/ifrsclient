...
export class RightofusescheduleComponent implements OnInit {
  ...
  constructor(private router: Router, public displayError: DisplayError
    , private rightOfUseScheduleService: rightOfUseScheduleService, private spinner: NgxSpinnerService) {
